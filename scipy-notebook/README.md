...
This Docker image is for SciPy with Jupyter Notebook. This images inherits [compdatasci/base](https://quay.io/repository/compdatasci/base). 
...
```
    ...
    $(docker-machine ip $(docker-machine active)):8088:8088 quay.io/compdatasci/scipy-notebook \
...
You can also run the image as a Linux environment for SciPy. You can run the image using the following command:
    ...
    quay.io/compdatasci/scipy-notebook:latest
