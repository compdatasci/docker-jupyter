...
[![Docker Repository on Quay](https://quay.io/repository/compdatasci/pandas-notebook/status "Docker Repository on Quay")](https://hub.docker.com/r/compdatasci/pandas-notebook)
...
```
    ...
    $(docker-machine ip $(docker-machine active)):8088:8088 compdatasci/pandas-notebook \
...
You can also run the image as a Linux environment for Pandas. You can run the image using the following command:
    ...
    compdatasci/pandas-notebook:latest
